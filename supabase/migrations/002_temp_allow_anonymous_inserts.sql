...
--              ⚠️ REVERT THIS IN PRODUCTION AFTER AUTH IS IMPLEMENTED
-- =====================================================
...
--
-- The original authenticated-only policies from 001_initial_schema.sql
-- will remain active after removing these temporary ones.
-- =====================================================
